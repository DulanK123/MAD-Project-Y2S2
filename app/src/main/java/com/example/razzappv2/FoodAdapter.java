...
public class FoodAdapter extends FirebaseRecyclerAdapter<FoodModel,FoodAdapter.myViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull FoodModel model) {
            ...
            public void onClick(View v) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("foodproduct")
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.food_main_layout,parent,false);
